...
<body>
	...
	<br>
	<a href="<%=request.getContextPath() %>/simple?type=date">일반요청</a>
	<br>
	<a href="<%=request.getContextPath() %>/simple?type=aaa">일반요청</a>
	<br>
	...
	<a href="<%=request.getContextPath() %>/Front.do?cmd=greeting">요청보내기(@anntation)</a>
	<br>
</body>
</html>